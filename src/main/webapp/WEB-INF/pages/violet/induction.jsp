...
var imgname=["F1.jpg","F2.jpg","F3.jpg","F4.jpg","F5.jpg","F6.jpg"];
var choicea=[1,1,0,2,2,1];
var choiceb=[4,4,4,4,4,3];
var number=0;
var jindu=0;
var choice="";
var time=0;
...
$(function(){
	$.ajax({
		...
		$("#ques_submit").click(function(){
			...
			choice=choice.substring(1).split(",");
			var student_choicea=parseInt(choice[0]);
			var student_choiceb=parseInt(choice[1]);
			var student_score = 0;
			var question_no=0;
			var reaction_time=getNs()-time;
// 			alert("a:"+student_choicea+" b:"+student_choiceb+" aa:"+choicea[jindu-1]+" bb:"+choiceb[jindu-1]);
			if(jindu<7){
				question_no=jindu;
			}
			if(choicea[jindu-1] == student_choicea){
				student_score=student_score+1;
			}
			if(choiceb[jindu-1] == student_choiceb){
				student_score=student_score+1;
			}
			$.post("<%=path%>/violet/induction/inductionsave",{"student_choicea":student_choicea,"student_choiceb":student_choiceb,"student_score":student_score,"question_no":question_no,"reaction_time":reaction_time});
			imgqiehuan();
			$("#ques_submit").attr("disabled","disabled");
		});
	});
