...
<div class="fullscreen" id="swf1">
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="750" id="FlashID">
				<param name="movie" value="${stc }swf/1_6/1_6.swf">
				...
				<!--[if !IE]>-->
				<object data="${stc }swf/1_6/1_6.swf" type="application/x-shockwave-flash" width="1000" height="750" align="absmiddle" id="FlashID2">
						<!--<![endif]-->
						<param name="quality" value="high">
						<param name="wmode" value="opaque">
						<param name="swfversion" value="7.0.70.0">
