...
var music=["0-40.MP3","20-95.MP3","30-90.MP3","85-70.MP3","95-10.MP3","100-55.MP3"];
var mtime=[3,3,3,3,3,3];
var mdaan=[0,0,0,1,1,1];
var musicurl="${stc }audio/ydxx/";
var mnum=0;
var isclick=false;
var isclickt=false;
var isclicky=false;
...
// 		var browserVersion = (userAgent.match(new RegExp('.+(?:version)[\/: ]([\\d.]+)')) || userAgent.match(new RegExp('(?:'+browserId+')[\/: ]([\\d.]+)')) || [0,'0'])[1];
	    ...
	    setTimeout(function(){
	    	...
	    	isclickt=true;
	    	time=getNs();
	    },mtime[mnum]*1000+2200);	//200毫秒是网络延迟
	    mnum=mnum+1;
	    isclick=false;
	}
}
function datasub(clickkey){
	...
	$.post("<%=path%>/whatet/musicform/musicFormsave",{"question_no":question_no,"question_right":question_right,"student_score":student_score,"student_choice":student_choice,"reaction_time":reaction_time});
}
</script>
</head>
