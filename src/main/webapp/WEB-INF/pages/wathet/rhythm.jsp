...
var music=["1.MP3","2.MP3","3.MP3","4.MP3","5.MP3","6.MP3"];
var mtime=[61,84,82,81,75,96];
var mdaan=[1,0,1,1,0,0];
var musicurl="${stc }audio/jzxx/";
var mnum=0;
var isclick=false;
var isclickt=false;
var isclicky=false;
...
function datasub(clickkey){
	...
	$.post("<%=path%>/whatet/musicrhythm/musicRhythmsave",{"question_no":question_no,"question_right":question_right,"student_score":student_score,"student_choice":student_choice,"reaction_time":reaction_time});
}
</script>
</head>
