...
$(function(){
	...
	if(preTime){
		...
		time=time2;
		$.post("<%=path%>/green/TestOperationb/testOperationbsave",{"student_score":option_score,"question_no":question_no,"student_choice":student_choice,"reaction_time":reaction_time,"test_no":test_no,"kinds":4});
		ajaxquestion();
}
...
function sendAjaxQuestion(pagestart, pagesize) {
	$.ajax({
		type: "POST",
		url: "/gray/personalityB/Questiondatas",
