...
<style>
body{ background:url(${stc }images/rg1/bk.jpg) no-repeat center center;}
.tips{}
.tips .bd{ color:#000;}
...
$(function(){
	...
	function daansubmit(student_choice,option_score){
		...
		time=time2;
		$.post("<%=path%>/green/TestOperationb/testOperationbsave",{"student_score":option_score,"question_no":question_no,"student_choice":student_choice,"reaction_time":reaction_time,"test_no":test_no,"kinds":3});
		ajaxquestion();
}
...
function sendAjaxQuestion(pagestart, pagesize) {
	$.ajax({
		type: "POST",
		url: "/gray/personalityA/Questiondatas",
...
<div class="fullscreen" id="swf1">
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="750" id="FlashID">
				<param name="movie" value="${stc }swf/rg1.swf">
				...
				<!--[if !IE]>-->
				<object data="${stc }swf/rg1.swf" type="application/x-shockwave-flash" width="1000" height="750" id="FlashID2" align="absmiddle">
						<!--<![endif]-->
						<param name="quality" value="high">
						<param name="wmode" value="opaque">
						<param name="swfversion" value="7.0.70.0">
