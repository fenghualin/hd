package com.huanduguihua.yellow.question3.bean;

import java.io.Serializable;

import com.huanduguihua.system.bean.DefaultBean;

public class TestResult extends DefaultBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2790182447402881540L;
	public String __getMyjdbcTableName() {return "test_resilt";}
