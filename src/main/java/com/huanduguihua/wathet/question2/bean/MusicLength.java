package com.huanduguihua.wathet.question2.bean;

import java.io.Serializable;

import com.huanduguihua.system.bean.DefaultBean;

public class MusicLength extends DefaultBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -3983233393937714784L;
	private Integer id;
