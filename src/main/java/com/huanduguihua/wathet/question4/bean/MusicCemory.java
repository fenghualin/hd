package com.huanduguihua.wathet.question4.bean;

import java.io.Serializable;

import com.huanduguihua.system.bean.DefaultBean;

public class MusicCemory extends DefaultBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1076525245441119851L;
	private Integer id;
