package com.huanduguihua.wathet.question1.bean;

import java.io.Serializable;

import com.huanduguihua.system.bean.DefaultBean;

public class MusicForm extends DefaultBean implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5896933121480890104L;
	private Integer id;
