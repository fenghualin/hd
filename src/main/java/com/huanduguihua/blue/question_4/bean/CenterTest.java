package com.huanduguihua.blue.question_4.bean;

import java.io.Serializable;

import com.huanduguihua.system.bean.DefaultBean;

public class CenterTest extends DefaultBean implements Serializable {
	private static final long serialVersionUID = 874916818877289049L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CenterTest other = (CenterTest) obj;
		if (accuracy == null) {
	...
	public String toString() {
		return "CenterTest [testNo=" + testNo + ", userId=" + userId
