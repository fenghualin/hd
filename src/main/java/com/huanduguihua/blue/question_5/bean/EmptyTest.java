package com.huanduguihua.blue.question_5.bean;

import java.io.Serializable;

import com.huanduguihua.system.bean.DefaultBean;

public class EmptyTest extends DefaultBean implements Serializable{
	private static final long serialVersionUID = 3685031921944214516L;
	...
	private Integer reactionChioce;
	...
	public Integer getReactionChioce() {
		return reactionChioce;
	}
	public void setReactionChioce(Integer reactionChioce) {
		this.reactionChioce = reactionChioce;
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((reactionChioce == null) ? 0 : reactionChioce.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (range == null) {
			...
			return false;
		if (reactionChioce == null) {
			if (other.reactionChioce != null)
				return false;
		} else if (!reactionChioce.equals(other.reactionChioce))
			return false;
	...
	public String toString() {
		return "EmptyTest [id=" + id + ", testNo=" + testNo + ", userId="
				+ userId + ", questioinNo=" + questionNo + ", reactionTime="
				+ reactionTime + ", reactionChioce=" + reactionChioce
