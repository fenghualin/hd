package com.huanduguihua.orange.question3.bean;

import java.io.Serializable;

import com.huanduguihua.system.bean.DefaultBean;

public class ColorContrast extends DefaultBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5509662453377326498L;
	private Integer id;
